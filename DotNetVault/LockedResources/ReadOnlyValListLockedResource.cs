...
namespace DotNetVault.LockedResources
{
        ...
        where TVault : ReadWriteListVault<TItem, BigValueList<TItem>> where TItem : struct, IEquatable<TItem>, IComparable<TItem>
    {
        ...
        #region Private CTOR
        private RoValListLockedResource([NotNull] TVault v, [NotNull] Vault<BigValueList<TItem>>.Box b,
        ...
        #region Dispose And Upgrade Methods
        /// <summary>
        ...
        /// <summary>
        /// Searches the list for a given element using a linear search
