...
namespace DotNetVault.CustomVaultExamples.CustomLockedResources
{
    ...
    public readonly ref struct LockedMonitorStringBuilder
    {
        ...
        internal static LockedMonitorStringBuilder CreateLockedResource(
            LockedMonVaultMutableResource<MutableResourceMonitorVault<StringBuilder>, StringBuilder> me)
        ...
        /// Private CTOR
        /// </summary>
        /// <param name="wrappedLockedResource">The resource from <see cref="LockedMonVaultMutableResource{TVault,TResource}"/>
        /// that this object will be wrapping
        /// and assuming disposal obligations</param>
        private LockedMonitorStringBuilder(
            LockedMonVaultMutableResource<MutableResourceMonitorVault<StringBuilder>, StringBuilder> wrappedLockedResource) =>
        ...
        #region Privates
        private readonly LockedMonVaultMutableResource<MutableResourceMonitorVault<StringBuilder>, StringBuilder> _resource;
        #endregion
    }
}