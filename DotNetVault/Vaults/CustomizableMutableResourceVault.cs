...
namespace DotNetVault.Vaults
{
    ...
    public abstract class CustomizableMutableResourceVault<T> : MutableResourceVault<T>
    {
        ...
        protected CustomizableMutableResourceVault(TimeSpan defaultTimeout) : base(defaultTimeout)
        {
