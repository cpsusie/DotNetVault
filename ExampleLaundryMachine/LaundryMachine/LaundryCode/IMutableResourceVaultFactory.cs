...
{
    public interface IMutableResourceVaultFactory<TDerivedMutableResourceVault, TResource> where TDerivedMutableResourceVault : MutableResourceVault<TResource>
    {
        /// <summary>
        /// Create a vault
        /// </summary>
