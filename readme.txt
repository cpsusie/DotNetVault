...
If you cannot read the README.md file locally, please use the following link to read it on github: https://github.com/cpsusie/DotNetVault/blob/v0.2.5.x/README.md#dotnetvault.
