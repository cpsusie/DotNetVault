...
namespace VaultUnitTests
{
    ...
    {
        public BasicMonVaultAcqBehaviorTests([NotNull] ITestOutputHelper helper, [NotNull] VaultFactoryFixture fixture) :
            base(helper, fixture)
        {
        ...
        [NotNull] private readonly MonVaultCreationMethod _meth;
    }
}
