...
{
    using VaultType = DotNetVault.Vaults.BasicVault<ResourceType>;

    public delegate VaultType VaultCreationMethod(TimeSpan timeout, Func<ResourceType> ctor = null);
    public sealed class BasicVaultAcqBehaviorTests : VaultAcqBehaviorTest
    {
        public BasicVaultAcqBehaviorTests([NotNull] ITestOutputHelper helper, [NotNull] VaultFactoryFixture fixture) :
            base(helper, fixture)
        {
            _meth = (ts, ctor) => Fixture.CreateBasicVault<ResourceType>();
        }
        ...
        [NotNull] private readonly VaultCreationMethod _meth;
    }
}
